    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card 
            ...
            description="We'll work to map out the end goals, target audience, and key functionalities. We'll discuss things like site structure, navigation and content requirements."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            ...
            description="This is where the magic happens! Based on the approved design, I'll translate everything into functional code, facilitating the final launch of the website."
        >
          <CanvasRevealEffect
            animationSpeed={3}
